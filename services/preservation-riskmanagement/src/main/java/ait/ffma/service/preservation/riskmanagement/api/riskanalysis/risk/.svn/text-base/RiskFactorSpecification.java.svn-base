...
public interface RiskFactorSpecification {

	/**
	 * returns the xml specification of risk properties and property sets as a stream
	 * @return
	 */
	public InputStream getRiskFactorSpecification ();
	
	/**
	 * @param spec the xml specification of risk properties and property sets
	 */
