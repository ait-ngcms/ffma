...
/**
 * This class is a container for Freebase file formats information like extension, version, mimetype, puid and xpuid.
 */
@SuppressWarnings({"restriction" })
@XmlRootElement
public class FreebaseFileFormat extends BaseFfmaDomainObject {
	 ...
	 */
	public FreebaseFileFormat () {
		setFfmaObjectName(FreebaseFileFormat.class.getSimpleName());
