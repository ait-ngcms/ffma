...
/**
 * This class is a container for AIT file formats information like extension, version, mimetype, puid and xpuid.
 */
@SuppressWarnings({"restriction" })
@XmlRootElement
public class AitFileFormat extends BaseFfmaDomainObject {

	private static final long serialVersionUID = 6650197210482459293L;
	 ...
	 */
	public AitFileFormat () {
		setFfmaObjectName(AitFileFormat.class.getSimpleName());
