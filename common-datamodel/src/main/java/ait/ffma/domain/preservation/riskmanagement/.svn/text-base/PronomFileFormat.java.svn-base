...
/**
 * This class is a container for PRONOM file formats information like extension, version, mimetype, puid and xpuid.
 */
@SuppressWarnings({"restriction" })
@XmlRootElement
public class PronomFileFormat extends BaseFfmaDomainObject {

	private static final long serialVersionUID = 8387865208080646209L;
	 ...
	 */
	public PronomFileFormat () {
		setFfmaObjectName(PronomFileFormat.class.getSimpleName());
