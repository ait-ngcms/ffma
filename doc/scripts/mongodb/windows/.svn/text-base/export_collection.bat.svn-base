...
if exist %1/mongoexport.exe goto CHECK_PAR_1  
echo ERROR: The export file "mongoexport.exe" in the directory "%1" not found!  
...
:EXECUTE
%1\mongoexport --host %2 --db %3 --collection %4 --fieldFile %4_fields.txt --out %4_json
