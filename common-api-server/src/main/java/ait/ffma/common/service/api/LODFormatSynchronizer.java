...
public interface LODFormatSynchronizer {
	 ...
	 */
	public abstract void updateFFDoc(String id,
			FfmaDomainObject ffDoc) throws SolrServerException,
	 ...
	 * @throws FfmaFunctionalException
	 */
	public void storeFFDoc(FfmaDomainObject ffDoc) throws SolrServerException, FfmaFunctionalException;
	 ...
	 * @throws FfmaFunctionalException
	 */
	public FfmaDomainObject readFFDoc(String id) throws SolrServerException, FfmaFunctionalException;
...
//	public List<SolrInputDocument> createInputDocumentByQuery(ModifiableSolrParams params)
	 ...
	 * @throws FfmaFunctionalException
	 */
	public void storeLODFormatsInSolr(List<FfmaDomainObject> lodFormatList) throws SolrServerException, FfmaFunctionalException;
